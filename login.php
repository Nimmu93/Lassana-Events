...
?>
   <!-- if (isset($_REQUEST['submit'])) {
        ...
        if ($login) {
            $user->get_admin($emailusername, $password);
         /*   if($employee = "stock"){
                 /* Registration Success*/
          /*  
            }
...
<body style="background-color: #656565;color:#f2f2f2">
    <div class="container">
                                ...
                                <form role="form" method="post">
                                    ...
                                    <h5>Enter details to log in</h5>
                                     ...
                                     <div class="col-lg-4 text-right" >
                                        <button class="btn btn-action" style="background-color:#124a76;" type="submit" name="submit">Sign in</button>
                                    </div>

                                    <p class="change_link" style="margin-top:10px; ">
                                        <a href="forgotpasswrd/rcvrpasswrd.php" style="color:#f2f2f2" class="to_register">Forgot Your Password?</a>
                                    </p>
                                    <hr />
