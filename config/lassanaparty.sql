...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2016 at 02:27 PM
...
INSERT INTO `orders` (`order_id`, `cname`, `cnumber`, `items`, `date`, `time`, `city`, `address`, `specialnotes`) VALUES
(1, 'Maduka Silva', 715016234, '4 chairs', '2016/08/28', '12.00', 'Colombo', 'University of Colombo', '2 black and 2 white'),
(2, 'Nimasha Jayathunga', 715974800, '4 tables', '2016/08/29', '12.00pm', 'Galle', '45/1, galle', '');
