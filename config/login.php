<?php
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($login == 'admin') {
           ...
           header("location:../admin/summonth.php");
        } 
    else if($login == 'stock') {
        header("location:../stock/orders.php");
    }else if($login =='clerk'){
        header("location:../clerk/tempReservation.php");
                            ...
                            <div class="panel-body">
                                <form role="form" method="post" action="">
                                    ...
                                    <p class="change_link" style="margin-top:10px;">
                                        <a href="forgotpassword/rcvrpasswrd.php" class="to_register">Forgot Your Password?</a>
                                    </p>
                                    <hr />
