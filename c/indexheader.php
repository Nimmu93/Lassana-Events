                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 no-padding">
                            ...
                            <ul id="hornavmenu" class="topnav" >
                                ...
                                <li>
                                     <a href="c/chairs.php">Chairs</a>
                                </li>
                                
                                <li>
                                    <a href="c/tables.php"><span >Tables</span></a>
                                ...
                                <li>
                                    <a href="c/gallery.php">Gallery</a>
                                </li>
                                
                                <li>
                                    <a href="c/contact.php">Contact </a>
                                </li>

                                <li>
                                    <a href="c/cart.php"><span class="fa fa-shopping-cart" >
                                    <?php
