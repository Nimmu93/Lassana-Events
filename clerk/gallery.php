...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Lassana Party | Weddings </title>
        <!-- Meta -->
                           ...
                           <div class="headline" >
                            ...
                            <div class="portfolio-filter-container margin-top-20">
                                <ul class="portfolio-filter">
                                    ...
                                    <li>
                                        <a href="weddings.html" class="btnpages" data-filter="gallary.html/design" >1</a>
                                    </li>
                                    <li>
                                        <a href="weddings2.html" class="btnpages " data-filter="gallary2.html/design">2</a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-md-12 portfolio-group no-padding" >
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div >
                                    <a href="#" >
                                        <figure>
                                            <img id="myimg" src="assets/img/wedding/wedding.jpg" alt="w1" width="90%" height="100%" style="margin-left:10% ">
