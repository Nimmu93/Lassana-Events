                        ...
                        <div class="col-md-12 portfolio-group no-padding">
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair1" width="60%" height="70%" style="margin-left:20%">
                                            
                                            <figcaption style="text-align:center">
                                                <h3 >Chair 1</h3>
                                                <a href="checkava.php" class="btnreserve">Reserve</a><br>
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair2" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 2</h3>
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair3" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 3</h3>
                                                <a href="add-item.html" class="btnreserve">Reserve</a><br>
                                                <span><br>Click on the image to zoom</span>
                                            </figcaption>
                                        </figure>
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair4" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 4</h3>
                                                <a href="add-item.html" class="btnreserve">Reserve</a><br>
                                                <span><br>Click on the image to zoom</span>
                                            </figcaption>
                                        </figure>
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair5" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 5</h3>
                                                <a href="add-item.html" class="btnreserve">Reserve</a><br>
                                                <span><br>Click on the image to zoom</span>
                                            </figcaption>
                                        </figure>
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair6" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 6</h3>
                                                <a href="add-item.html" class="btnreserve">Reserve</a><br>
                                                <span><br>Click on the image to zoom</span>
                                            </figcaption>
                                        </figure>
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair7" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 7</h3>
                                                <a href="add-item.html" class="btnreserve">Reserve</a><br>
                                                <span><br>Click on the image to zoom</span>
                                            </figcaption>
                                        </figure>
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair8" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 8</h3>
                                                <a href="add-item.html" class="btnreserve">Reserve</a><br>
                                                <span><br>Click on the image to zoom</span>
                                            </figcaption>
                                        </figure>
                           ...
                           <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/chairs/c.png" alt="chair9" width="60%" height="70%" style="margin-left:20%">
                                            <figcaption style="text-align:center">
                                                <h3 class="margin-top-20">Chair 9</h3>
                                                <a href="add-item.html" class="btnreserve">Reserve</a><br>
                                                <span><br>Click on the image to zoom</span>
                                            </figcaption>
                                        </figure>
