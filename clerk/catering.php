...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Lassana Party | Catering </title>
        <!-- Meta -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="headline" >
                                ...
                                <form> 
                                    ...
                                    <!--
                                            <th style="padding-top: 5px;padding-bottom: 5px;padding-right: 10px;padding-left: 10px;">Total Amount (Rs.) 
                                            </th>
                            ...
                            <div class="portfolio-filter-container margin-top-20">
                                <ul class="portfolio-filter">
                                    ...
                                    <li>
                                        <a href="catering.html.html" class="btnpages" data-filter="gallary.html/design" >1</a>
                                    </li>
                                    <li>
                                        <a href="catering2.html" class="btnpages " data-filter="gallary2.html/design">2</a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-md-12 portfolio-group no-padding">
                            ...
                            <div class="col-md-4 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                                            <img id="myimg" src="assets/img/catering/ca.jpg" alt="catering1" width="90%" height="100%" style="margin-left:5%">
                                            <br>
                                            
                                            <figcaption style="text-align:center">
                                                <h3 >Menu 1</h3>
                                                <a href="add-item.html" class="btnreserve">View Menu</a><br>
