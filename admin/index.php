...
$result = mysqli_query($conn,"SHOW TABLE STATUS WHERE `Name` = 'stock'");
...
$next_increment = $data['Auto_increment'] - 1;
	...
	$query = "update stock set location = '$thumb_image_location' WHERE id = '$next_increment' ";
